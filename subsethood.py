...
# Calcula a medida de subsethood de Kosko
# A similaridade eh dada por Integral(min(antecedente,entrada))/Integral(entrada))
...
def ativa_regra(iniRegra, topoRegra, fimRegra, iniEntrada, topoEntrada, fimEntrada):
	...
	denominador = integrate.quad(membership.triang, iniEntrada, fimEntrada, args=(iniEntrada,topoEntrada,fimEntrada))[0]
